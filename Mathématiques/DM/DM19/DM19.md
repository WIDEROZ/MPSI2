...
$$m_{r+1}-m = \frac{5}{2N(N+1)} \times \left( N-\left( \frac{6}{5}N_{r}+N_{v} +\frac{7}{15}N_{b}\right) \right)$$
$$m_{r+1}-m = \frac{5}{2N(N+1)} \times \left( N_r + N_{b}- \frac{6}{5}N_{r}-\frac{7}{5}N_{b} \right)$$
