...
Mais encore, 
$$m_{r+1 m_{r+1}-m m_{r+1}-m}-m =\frac{3}{N(N+1)} \times \left( N_{v} + N_{b} - \frac{5}{6}N_{v} - \frac{7}{6}N_{b} \right) $$
Donc, 
...
On a alors, 
$$m_{v+1} = \frac{3N_{r}+\frac{5}{2}N_{v}+ \frac{7}{2}N_{b}}{N+1} + \frac{5}{2(N+1)}$$
et
$$m_{v+1} - m = \frac{5}{2(N+1)} + \frac{-\left( 3N_{r}+\frac{5}{2}N_{v} +\frac{7}{2}N_{b}\right)}{N(N+1)}$$
...
$$m_{b+1} = \frac{3N_{r}+\frac{5}{2}N_{v}+ \frac{7}{2}N_{b}}{N+1} + \frac{7}{2(N+1)}$$
...
Soit $k \in \mathbb{N}^{*}$, 
Pour $\alpha \in \{ r, v, b \}$ on note $m_{\alpha + k}$ l'espérance de $X$ lorsqu'on ajoute 
Comme :
