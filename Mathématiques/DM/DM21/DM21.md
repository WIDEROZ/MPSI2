...
$$\cos(\pi x) \sim \cos(\pi x)$$

$$x = \sqrt{ n^{2} + n + 1 } \sim n+\frac{1}{2} + \frac{1}{2n}$$


On a : 
$$\sum_{n = 1}^{\infty} \cos(\pi \sqrt{ n^{2}+n+1 }) = \sum_{n = 1}^{\infty}\cos\left( \pi \left( n+\frac{1}{2} + \frac{1}{2n} + O\left( \frac{1}{n^{2}} \right)\right) \right)$$
