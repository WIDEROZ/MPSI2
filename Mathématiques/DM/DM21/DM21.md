...
## 2.
$$\sin(x) - x = -\frac{1}{2} \int _{0}^{x} (x-t)^{2}\cos(t) \, dt = -\frac{1}{2}\left[ -\frac{1}{3}(x-t)^{3} \right]_{0}^{x} = -\frac{1}{6}x^{3}$$
...
#### Synthèse
Comme :
$$0 < \arccos\left( \frac{6}{x^{2}}\left( 1- \frac{\sin(x)}{x} \right) \right) + 2k\pi < \frac{\pi}{2}$$
Alors, 
$$$$