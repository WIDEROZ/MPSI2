...
## 4.
$$\sum_{k = 1}^{n}\sin\left( \frac{k}{n} \right)\ln\left( 1+ \frac{k}{n^{2}} \right) \leq \frac{1}{2}\sum_{k=1}^{n} \sin\left( \frac{k}{n} \right) \frac{k^{2}}{n^{4}}$$
...
$$\sum_{k = 1}^{n} \sin\left( \frac{k}{n} \right) \frac{k^{2}}{n^{4}} \underset{n \to +\infty}{\longrightarrow} \int _{0}^{1} \sin(x)x^{2} \, dx $$
Alors, 
On fait deux IPP
$$\left[\! \left[ \begin{array}{l}
u = x^{2} \\
...
v = -\cos(x)
\end{array}\right.\right.$$
$$\int x^{2} \sin(x) \, dx = 2\int _{0}^{1} x\cos(x)  \, dx - [x^{2}\cos(x)]_{0}^{1} $$
___
$$\left[\! \left[ \begin{array}{l}
u = x \\
dv =  \cos(x) dx
...
v = \sin(x)
\end{array}\right.\right.$$
$$\int _{0}^{1} x\cos(x) \, dx = [x \sin(x)]_{0}^{1} - \int _{0}^{1} \sin(x)\, dx = \sin(1) + \cos(1)$$
___
Alors, 
$$\int_{0}^{1} x^{2} \sin(x) \, dx = 2(\sin(1) + \cos(x)) - \cos(x) = 2\sin(1) + \cos(1)$$
