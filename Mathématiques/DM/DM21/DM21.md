...
$$\sum_{n \Rightarrow 1} u_{n} = \sum_{\sqrt{ n } \in \mathbb{N}} \frac{1}{n} + \sum_{\sqrt{ n } \notin \mathbb{N}} \frac{1}{n^{2}}$$
...
On pose : $S_{1} = \sum_{\sqrt{ n } \in \mathbb{N}} \frac{1}{n}$ la série extraite de $\sum_{n \geq 1} \frac{1}{n}$ qui diverge. 

Par l'absurde supposons que $\sum_{\sqrt{ n }\in\mathbb{N}} \frac{1}{n}$ 