...
- $R$ : point de rosée qui correspond à la première apparition du liquide. La pression en ce point est nommée pression de vapeur saturante : $P_{sat}(T)$ 
...
___
Démo alternative mieux : 
Au point $M$ : 
$$\begin{array}{rl}
V &= V_{l}+V_{v} \\
&= m_{l}v_{l} + m_{v}v_{v} \\
&= (m-m_{v})v_{l}+m_{v}v_{v}
\end{array}$$
Alors, 
